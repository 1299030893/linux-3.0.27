...
#if defined(CONFIG_SND_TI81XX_SOC_UDDVR) || defined(CONFIG_SND_TI81XX_SOC_EVM) || defined(CONFIG_SND_TI81XX_ACLBRD) // hbchen , merge from 1.09
...
static int davinci_mcasp_probe(struct platform_device *pdev)
{
...
#if defined(CONFIG_SND_TI81XX_SOC_UDDVR) && defined(CONFIG_MACH_UD8107_DVR)
    struct clk *parent;
#endif
...
#if defined(CONFIG_SND_TI81XX_SOC_UDDVR) && defined(CONFIG_MACH_UD8107_DVR)
    /* change clkmux to sysclk22(20MHz) */
    ...
    if (ret < 0) {
        printk(KERN_ERR "mcasp%d:Unable to set parent clk\n", pdev->id);
        ret = -ENODEV;
        goto err_release_region;
    }
#endif
