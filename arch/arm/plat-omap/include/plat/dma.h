...
#if 1 // def ACL_MMC2 // hbchen , need change ??
#define OMAP24XX_DMA_MMC2_TX		40	// hbchen // original for can0 IF1
#define OMAP24XX_DMA_MMC2_RX		41	// hbchen // original for can0 IF2
#else
