...
static int tlc59108_bl_suspend(struct i2c_client *client, pm_message_t pm)
{
	struct tlc59108_bl *data = i2c_get_clientdata(client);

	tlc59108_bl_set_backlight(data, 0);

	return 0;
}

static int tlc59108_bl_resume(struct i2c_client *client)
{
	struct tlc59108_bl *data = i2c_get_clientdata(client);
...
static struct i2c_driver tlc59108_driver = {
	...
	.suspend = tlc59108_bl_suspend,
	.resume	= tlc59108_bl_resume,
